...
the size of the dataframe `mr_trash_wheel` is 344 rows and 14 columns.  
the median number of sports balls for 2017 8

the size of the dataframe `ppt_merged` is 24 rows and 3 columns. the
total precipiation for 2018 is 70.33
...
the size of the dataframe `full_data` is 822 rows and 11 columns.
