...
the size of the dataframe `mr_trash_wheel` is `r nrow(mr_trash_wheel)` rows and `r ncol(mr_trash_wheel)` columns.  
the median number of sports balls for 2017 `r median(pull(filter(mr_trash_wheel,year == 2017),sports_balls))`

the size of the dataframe `ppt_merged` is `r nrow(ppt_merged)` rows and `r ncol(ppt_merged)` columns.
...
the size of the dataframe `full_data` is `r nrow(full_data)` rows and `r ncol(full_data)` columns.
